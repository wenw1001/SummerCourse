...
int main(int argc, char **argv)
{
  ...
  */ 
  ros::Publisher topic_pub = nh.advertise<std_msgs::String>("chatter", 1000);  
  ROS_INFO("talker.cpp START");
  ...
  while (ros::ok())
  {
    ...
    msg.data = "hello world";//ss.str();   // 寫入msg message中的data欄位 

    ROS_INFO("Pub msg: %s", msg.data.c_str());   
